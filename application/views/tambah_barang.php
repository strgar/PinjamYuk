...
<head>
    <meta charset="UTF-8">
    <title>Tambah Barang - PinjamYuk</title>
    ...
    <main class="main-content">
        <div class="container-main">
            <div class="page-header">
                <h1 class="h2"><i class="fas fa-plus-circle me-2"></i>Tambah Barang</h1>
                    ...
                    <form action="<?= site_url('barang/simpan') ?>" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="keterangan" 
                                      placeholder="Contoh: Barang IT" rows="4" required></textarea>
                        </div>
