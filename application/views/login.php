  ...
  <body>
    <form class="form-signin" method="post" action="<?php echo site_url('Login/masuk'); ?>">
      <div class="text-center mb-4">
        ...
        <h1 class="h3 mb-3 font-weight-normal text-white">Login Pinjam Yuk!</h1>
      </div>
      ...
      <p class="mt-3 text-center text-white">
        Belum punya akun? 
        <a href="<?php echo site_url('Login/daftar'); ?>" class="text-info">Sign up</a>
      </p>

      <p class="mt-5 mb-3 text-muted text-center">&copy; Pinjam Yuk <?php echo date("Y"); ?></p>
    </form>
  </body>
</html>
